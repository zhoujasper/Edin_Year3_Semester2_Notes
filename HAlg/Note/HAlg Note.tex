...
\quad \textbf{Remark}: For $\{\vec{v}_1,...,\vec{v}_n\}$ orthonormal basis. \quad $\vec{v}=\sum_{i=1}^n(\vec{v},\vec{v}_i)\vec{v}_i$. 

\quad \textbf{Theorem}: {\small Every \underline{finite}-dimensional inner product space has an orthonormal basis.}

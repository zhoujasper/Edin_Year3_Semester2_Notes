...
\textbf{Invertible Matrices}: $A$ is invertible if $\exists B,C$ s.t. $BA=I$ and $AC=I$
...
\quad Then $_{\mathcal{B}}[f]_{\mathcal{A}}=A$ {\small (matrix)} where $f(\vec{v}_{i\in\mathcal{A}})=\sum_{j\in\mathcal{B}}A_{ji}\vec{w}_j$ \quad \quad $\exists \phi:Mat(n\times m;F)\bij Hom_{F}(F^m,F^n)$ $\Rightarrow$ $\left[ \ [f]=I\Leftrightarrow f=id \ \right]$

$\cdot$ \textbf{Theorems}: $[f\circ g]=[f]\circ[g]$ \quad \quad $_{\mathcal{C}}[f\circ g]_{\mathcal{A}}=_{\mathcal{C}}[f]_{\mathcal{B}}\circ_{\mathcal{B}}[g]_{\mathcal{A}}$ \quad \quad $_{\mathcal{B}}[f(\vec{v})]=_{\mathcal{B}}[f]_{\mathcal{A}}\circ_{\mathcal{A}}[\vec{v}]$

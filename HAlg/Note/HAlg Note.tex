...
\textbf{Integral Domain}: A \textit{commutative} ring $R$ is an integral domain if it has no zero-divisors.
...
$\cdot$ \textit{Field is Integral Domain} \qquad \textbf{Every finite integral domain is a field} \qquad {\scriptsize e.g.(integral domain) $\mathbb{Z};\mathbb{Z}/p\mathbb{Z}$}

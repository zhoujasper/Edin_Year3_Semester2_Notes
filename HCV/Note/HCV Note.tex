...
\begin{enumerate}[itemsep=-2pt, topsep=-2pt]
    \item \textbf{Singularity of rational function}: If $z_0$ is \textit{singularity} of \textit{rational function} $f$, then $z_0$ is \textit{isolated}.
    ...
    \item \textbf{Rational Function}: If $f,g$ holomorphic at 
\end{enumerate}

...
\textbf{Useful Tools}: $\text{Re}(z)=0 \Leftrightarrow z=-\overline{z}$ \quad $\text{Im}(z)=0 \Leftrightarrow z=\overline{z}$ \qquad In \textit{circle}, $\overline{z}=|z|^2z^{-1}$
...
\begin{enumerate}[itemsep=-2pt, topsep=-2pt]
    ...
    \item \textbf{Useful Property}: For $f(z)=\frac{az+b}{cz+d}$, $M=\frac{1}{ad-bc}${\scriptsize $\begin{pmatrix} a & b \\  c & d\end{pmatrix}$} \qquad and $f^{-1}(z)=\frac{dz-b}{-cz+a}$ \quad $\big|$ \quad {\scriptsize Why $ad-bc\ne0$: $f'(z)\ne0 \ \forall z\in\mathbb{C}$ iff $ad-bc\ne0$}
...
\begin{enumerate}[itemsep=-2pt, topsep=-2pt]
    \item \textbf{Liouville's Theorem}: $|f(z)|<M$ \textit{bounded} on $\forall z \in \mathbb{C}$, \ $\Rightarrow$ \ $f(z)$ is \textit{constant}. \qquad {\scriptsize ps: 此定理通过Generalised Cauchy Formula + ML Lemma 得到}

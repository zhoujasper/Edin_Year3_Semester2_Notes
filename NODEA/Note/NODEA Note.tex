...
\quad $\Rightarrow$ Suppose $\frac{dy}{dt}=f(t,y)$. We approximate $\Phi_{t,h}(y)$: $\widehat{\Phi}_{t_0,h}(y)= y+hf(t_0,y)$ \quad {\scriptsize (通过对$y$在$t_0+h$处泰勒展开得到;{\tiny 直观想象考虑三角形(不严格),同理欧拉})}
